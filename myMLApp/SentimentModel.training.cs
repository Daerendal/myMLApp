    ...
    public partial class SentimentModel
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(@"col0", @"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(l1Regularization:3.57200480137414F,l2Regularization:0.171333621007395F,labelColumnName:@"col1",featureColumnName:@"Features"))      
